...
class SelectTimeGui(private val plugin: FFAPlugin, private val shopConfigItem: ShopConfigItem) : InventoryProvider {

    companion object {
        fun getInventory(plugin: FFAPlugin, shopConfigItem: ShopConfigItem): SmartInventory = SmartInventory.builder()
                .id("shopGuiTimeSlect")
