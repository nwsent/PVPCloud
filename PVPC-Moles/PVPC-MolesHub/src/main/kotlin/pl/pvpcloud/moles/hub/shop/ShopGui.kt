...
class ShopGui(private val plugin: MolesPlugin) : InventoryProvider {
    ...
    override fun init(player: Player, contents: InventoryContents) {
        ...
        this.plugin.shopConfig.shopItems.forEach {
            ...
            if (purchase == null) {
                ...
                itemMeta.lore = arrayListOf("", "&8* &7Status&8: &ePrzedmiot kupiony".fixColors(), "     &8(&7Wygasa&8: &e${DataHelper.formatData(purchase.expireTime)}&8)".fixColors(), "", "&8* &7Cena od&8: &e${it.startPrice}".fixColors(), "")
            }
