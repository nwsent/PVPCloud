...
class SelectTimeGui(private val plugin: MolesPlugin, private val shopConfigItem: ShopConfigItem) : InventoryProvider {

    companion object {
        fun getInventory(plugin: MolesPlugin, shopConfigItem: ShopConfigItem): SmartInventory = SmartInventory.builder()
                .id("shopGuiTimeSlect")
