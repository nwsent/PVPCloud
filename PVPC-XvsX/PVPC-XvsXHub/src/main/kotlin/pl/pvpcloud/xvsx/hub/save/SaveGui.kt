...
class SaveGui(private val plugin: XvsXPlugin, private val kit: Kit) : InventoryProvider {

    companion object {
        fun getInventory(plugin: XvsXPlugin, kit: Kit): SmartInventory = SmartInventory.builder()
                .id("save")
