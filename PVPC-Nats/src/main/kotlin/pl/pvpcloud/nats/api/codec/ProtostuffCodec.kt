...
class ProtostuffCodec(bufferSize: Int) : INatsCodec {
    ...
    override fun encode(packet: PacketWrapper): ByteArray {
        try {
            return ProtostuffIOUtil.toByteArray(packet, this.schema, this.buffer)
        } finally {
            this.buffer.clear()
        }
    }
    ...
    override fun decode(byteArray: ByteArray): PacketWrapper {
        ...
        ProtostuffIOUtil.mergeFrom(byteArray, packet, this.schema)
